...
<?php $component->withAttributes([]); ?>
    ...
    <style>
        ...
        .customSwalBtn{
            background-image: url("<?php echo e(asset('storage/img/icons/star.png')); ?>");
        ...
        .customSwalBtn:hover{
            background-image: url("<?php echo e(asset('storage/img/icons/star_hover.png')); ?>");
        }
    ...
    <script type="text/javascript">
        ...
        const starUrl = "<?php echo e(asset('storage/img/icons/star.png')); ?>";
        const starMiniUrl = "<?php echo e(asset('storage/img/icons/star_mini.png')); ?>";
        const baseUrl = "<?php echo e(asset('')); ?>";
        const geoJson = "<?php echo e(asset('storage/route.json')); ?>";
        const routeIcon = "<?php echo e(asset('storage/img/icons/route.png')); ?>";
        ...
        function find_stations(city) {
            ...
            $.ajax({
                ...
                data: {
                    client_id:      "<?php echo e(config('services.places_api.client_id')); ?>",
                    client_secret:  "<?php echo e(config('services.places_api.secret')); ?>",
                    v:              '20180323',
                    limit:          100,
        ...
        function getATMs(){
            $.ajax({
                dataType: "json",
                url: "https://api.foursquare.com/v2/venues/search?client_id=<?php echo e(config('services.places_api.client_id')); ?>&client_secret=<?php echo e(config('services.places_api.secret')); ?>&v=20180323&limit=100&ll=54.371570473891865,18.61244659572624&query=atm",
                data: {},
